...
import {Icon, Button, Field} from "@heintouchable/ui";
 ...
 */
function CommentsComponent({content_id, comment_id}) {
...
export default class Comments extends HTMLElement {
    private content_id: string | null | undefined;
    ...
    connectedCallback() {
        ...
        createRoot(this).render(
            <CommentsComponent content_id={this.content_id} comment_id={this}/>
        );
    }
}
