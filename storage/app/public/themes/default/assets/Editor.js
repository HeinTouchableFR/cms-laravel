...
// src/Editor.tsx
import React10, { useEffect as useEffect10, useMemo as useMemo6, useRef as useRef10 } from "react";
...
function Button({
  ...
  return /* @__PURE__ */ jsxs(BaseButton, {
    ...
    ...props,
    children: [
      IconElement && /* @__PURE__ */ jsx2(IconElement, {
        size: 20
      }),
      children
    ]
...
function ButtonIcon({
  ...
  const style = rotate ? { transform: `rotate(${rotate}deg)`, ...additionalStyle } : additionalStyle;
  const button = /* @__PURE__ */ jsx4("button", {
    ...props,
    className: `${_default["button__icon"]} ${danger && _default.danger} ${success && _default.success}`,
    "aria-label": title,
    style
  });
  if (title) {
...
import { Field as FieldUi } from "@heintouchable/ui";
...
function Field({
  ...
  return /* @__PURE__ */ jsxs2("div", {
    ...
    children: [
      ...
      help && /* @__PURE__ */ jsx5(HelpMessage, {
        children: help
      })
    ]
  });
...
import { prevent } from "@heintouchable/functions";
  ...
  return /* @__PURE__ */ jsxs4(RadixTabs, {
    ...
    children: [
      /* @__PURE__ */ jsx7(TabsList, {
        ...props,
        children: childrenArray.map((child) => /* @__PURE__ */ jsx7(TabButton, {
          css: [currentTab === child.props.title && TabButtonSelected],
          value: child.props.title,
          children: child.props.title
        }, child.props.title))
      }),
      childrenArray.map((child) => /* @__PURE__ */ jsx7(TabsContent, {
        value: child.props.title,
        children: child
      }, child.props.title))
    ]
...
var PresenceChild = ({
  ...
  return /* @__PURE__ */ jsx9(ClassNames, {
    children: ({ css: css2, cx }) => React2.cloneElement(children, {
      className: cx(
...
var AnimatePresence = ({ children, in: inKeyframes, out: outKeyframes, exitBeforeEnter }) => {
  ...
  if (isInitialRender.current) {
    ...
    return /* @__PURE__ */ jsx10(Fragment2, {
      children: filteredChildren.map((child) => /* @__PURE__ */ jsx10(PresenceChild, {
        isPresent: true,
        in: inKeyframes,
        out: outKeyframes,
        children: child
  ...
  childrenToRender = childrenToRender.map((child) => {
    const key = child.key;
    return exiting.has(key) ? child : /* @__PURE__ */ jsx10(PresenceChild, {
      isPresent: true,
      in: inKeyframes,
      out: outKeyframes,
      children: child
  ...
  return /* @__PURE__ */ jsx10(Fragment2, {
    children: exiting.size ? childrenToRender : childrenToRender.map((child) => cloneElement2(child))
  });
};
...
import { Alert } from "@heintouchable/ui";
...
function Flash({
  ...
  return /* @__PURE__ */ jsx11(AnimatePresence, {
    in: FlashIn,
    out: FlashOut,
    children: children && /* @__PURE__ */ jsx11(Alert, {
      duration,
      isFloating: true,
...
import { jsx as jsx12, jsxs as jsxs5 } from "@emotion/react/jsx-runtime";
...
import { jsx as jsx13, jsxs as jsxs6 } from "@emotion/react/jsx-runtime";
...
// src/components/Sortable.tsx
import { jsx as jsx14, jsxs as jsxs7 } from "@emotion/react/jsx-runtime";
function SortableWrapper({
  ...
  function handleDragEnd(event) {
    ...
    if (over && active.id !== over.id) {
      onMove(
        ids.indexOf(active.id.toString()),
        ids.indexOf(over.id.toString())
      );
    }
  }
...
import { deepSet, indexify } from "@heintouchable/functions";
import { combine, devtools } from "zustand/middleware";
import { uniqId } from "@heintouchable/functions";
import createContext2 from "zustand/context";
import { clamp } from "@heintouchable/functions";
...
import { memo, useMemo as useMemo2, useRef as useRef4 } from "react";
import { useUpdateEffect } from "@heintouchable/functions";
import { strToDom } from "@heintouchable/functions";
...
import { prevent as prevent2 } from "@heintouchable/functions";
...
// src/components/Sidebar/SidebarBloc.tsx
import { prevent as prevent4 } from "@heintouchable/functions";
...
function FieldsRenderer({
  ...
  return /* @__PURE__ */ jsx18(Fragment3, {
    children: fields.filter((field) => field.shouldRender(data)).map(
      (field, k) => field.group ? /* @__PURE__ */ jsx18(field.render, {
...
import { prevent as prevent3 } from "@heintouchable/functions";
import { copyToClipboard } from "@heintouchable/functions";
import { stringifyFields } from "@heintouchable/functions";
...
function CopyAction({ data, size, ...props }) {
  ...
  return /* @__PURE__ */ jsx20(Tooltip, {
    content: success ? /* @__PURE__ */ jsxs9(Fragment4, {
      children: [
        t("copySuccess"),
        /* @__PURE__ */ jsx20("br", {}),
        t("copyInstructions")
    ...
    children: /* @__PURE__ */ jsx20("div", {
      children: /* @__PURE__ */ jsx20(ButtonIcon, {
        ...
        success,
        ...props,
        children: success ? /* @__PURE__ */ jsx20(IconCheck, {
          size
...
// src/components/Sidebar/SidebarBloc.tsx
import { useToggle } from "@heintouchable/functions";
import { jsx as jsx21, jsxs as jsxs10 } from "@emotion/react/jsx-runtime";
var SidebarBloc = memo(function SidebarItem({
  ...
  return /* @__PURE__ */ jsxs10(SidebarBlocWrapper, {
    ...
    children: [
      ...
      !isCollapsed && /* @__PURE__ */ jsx21(Flex, {
        column: true,
        gap: 1,
        css: { marginTop: ".5em" },
...
function SidebarBlocs({ data }) {
  ...
  return /* @__PURE__ */ jsx22(Wrapper5, {
    children: /* @__PURE__ */ jsx22(SortableWrapper, {
      items: data,
      onMove: handleMove,
      children: data.map((v, k) => /* @__PURE__ */ jsx22(SidebarBloc, {
        data: v,
...
import { prevent as prevent5 } from "@heintouchable/functions";
      ...
      /* @__PURE__ */ jsxs11(Flex, {
        children: [
          ...
          /* @__PURE__ */ jsx23(ButtonIcon, {
            ...
            children: isPhone ? /* @__PURE__ */ jsx23(IconDesktop, {
              size: 20
...
import { prevent as prevent6 } from "@heintouchable/functions";
...
import { prevent as prevent7 } from "@heintouchable/functions";
...
function SidebarTemplates({ onTemplate }) {
  ...
  return /* @__PURE__ */ jsx26(Wrapper9, {
    children: templates2.map((t2) => /* @__PURE__ */ jsx26(TemplateCard, {
      template: t2,
      onClick: callback,
...
// src/components/Sidebar/Sidebar.tsx
import { prevent as prevent8 } from "@heintouchable/functions";
  ...
  return /* @__PURE__ */ jsxs14(SidebarWrapper, {
    ...
    children: [
      /* @__PURE__ */ jsx27(SidebarHeader, {
        onClose,
        children: hasTemplates && /* @__PURE__ */ jsx27(ButtonIcon, {
      ...
      state === 0 /* BLOCS */ && (showEmpty ? /* @__PURE__ */ jsx27(SidebarEmpty, {
        onAction: () => setState(1 /* TEMPLATES */)
      }) : /* @__PURE__ */ jsx27(SidebarBlocs, {
        data
      })),
      state === 1 /* TEMPLATES */ && /* @__PURE__ */ jsx27(SidebarTemplates, {
...
import { prevent as prevent9 } from "@heintouchable/functions";
...
import { useEffectDebounced } from "@heintouchable/functions";
...
// src/components/Preview/PreviewItem.tsx
import { offsetTop } from "@heintouchable/functions";
import { Flipped } from "react-flip-toolkit";
import { Loader } from "@heintouchable/ui";
...
import { prevent as prevent10 } from "@heintouchable/functions";
...
// src/components/Preview/PreviewItems.tsx
import { Fragment as Fragment5, jsx as jsx31, jsxs as jsxs16 } from "@emotion/react/jsx-runtime";
  ...
  return /* @__PURE__ */ jsxs16(Fragment5, {
    children: [
      /* @__PURE__ */ jsx31(Flipper, {
        ...
        children: data.map((v, k) => /* @__PURE__ */ jsxs16("div", {
          children: [
...
// src/components/Preview/Preview.tsx
import { useAsyncEffect } from "@heintouchable/functions";
import { Loader as Loader2 } from "@heintouchable/ui";
...
function Preview({ data, previewUrl }) {
  ...
  return /* @__PURE__ */ jsxs17("div", {
    ...
    children: [
      showSpinner && /* @__PURE__ */ jsx32(Loader2, {
        width: 40,
        dots: 12
      }),
      /* @__PURE__ */ jsx32("iframe", {
        className: `${loaded ? _default2.loaded : ""} ${previewMode === 0 /* PHONE */ ? _default2.mobile : ""}`,
        ref: iframe,
        style: transform,
...
import { useEffect as useEffect5, useMemo as useMemo3, useState as useState9 } from "react";

// src/components/Blocs/BlocSelectorItem.tsx
import { prevent as prevent11 } from "@heintouchable/functions";
...
function BlocSelector({ iconsUrl }) {
  ...
  return /* @__PURE__ */ jsxs21(Modal, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx36(Tabs, {
        css: { margin: "1.5rem 0" },
        children: categories.map((category) => /* @__PURE__ */ jsx36(BlocSelectorGrid, {
          title: category,
          children: Object.keys(definitions).filter(
            (key) => !hiddenCategories.includes(definitions[key].category ?? "")
          ).filter(searchDefinition(search ?? "", category, definitions)).map((key) => /* @__PURE__ */ jsx36(BlocSelectorItem, {
...
import { useToggle as useToggle2 } from "@heintouchable/functions";
  ...
  return /* @__PURE__ */ jsx38(Fragment7, {
    children: /* @__PURE__ */ jsxs22(Wrapper12, {
      ...
      children: [
        ...
        previewUrl && /* @__PURE__ */ jsx38(Preview, {
          data,
          previewUrl
        }),
...
// src/Editor.tsx
import { indexify as indexify3, stringifyFields as stringifyFields2 } from "@heintouchable/functions";

// src/hooks/useClipboardPaste.ts
import { useEffect as useEffect6 } from "react";
import { indexify as indexify2 } from "@heintouchable/functions";
...
// src/Editor.tsx
import { useUpdateEffect as useUpdateEffect2 } from "@heintouchable/functions";

// src/components/BaseStyles.tsx
import styled25 from "@emotion/styled";
import { css, Global } from "@emotion/react";
import { Fragment as Fragment8, jsx as jsx39, jsxs as jsxs23 } from "@emotion/react/jsx-runtime";
...
import { useStateDelayed, useStopPropagation } from "@heintouchable/functions";

// src/fields/Text.tsx
import { useUniqId } from "@heintouchable/functions";

// src/fields/utils.ts
import { cast } from "@heintouchable/functions";
...
import { useUniqId as useUniqId2 } from "@heintouchable/functions";
...
import { deepSet as deepSet2 } from "@heintouchable/functions";
import { textContent, uniqId as uniqId2 } from "@heintouchable/functions";
import { prevent as prevent12 } from "@heintouchable/functions";
import { useMemo as useMemo4, useState as useState10 } from "react";
import { useToggle as useToggle3 } from "@heintouchable/functions";
...
var Component3 = ({
  ...
  const add = () => {
    onChange([
      ...value,
      fillDefaults({ _id: uniqId2() }, options.fields)
    ]);
  ...
  return /* @__PURE__ */ jsx42(Field, {
    ...
    children: /* @__PURE__ */ jsx42(SortableWrapper, {
      ...
      children: /* @__PURE__ */ jsxs25("div", {
        ...
        children: [
          value.map((line, k) => /* @__PURE__ */ jsx42(FieldLine, {
            line,
            index: k,
      ...
      /* @__PURE__ */ jsxs25(SidebarHeading, {
        ...
        children: [
          /* @__PURE__ */ jsx42(SidebarHeading.Hover, {
            children: onRemove && /* @__PURE__ */ jsx42(ButtonIcon, {
              danger: true,
...
import { useUniqId as useUniqId3 } from "@heintouchable/functions";
import { prevent as prevent13 } from "@heintouchable/functions";
...
var Component4 = ({
  ...
  return /* @__PURE__ */ jsx43(Field, {
    ...
    help: options.help,
    value,
    tooltip: value ? /* @__PURE__ */ jsx43("img", {
    ...
    onChange: (e) => onChange(e.target.value),
    css: { paddingRight: 40 },
    icon: options.onBrowse ? /* @__PURE__ */ jsx43(ButtonIcon, {
      additionalStyle: {
        width: "32px",
        height: "32px"
      },
...
import { prevent as prevent17 } from "@heintouchable/functions";
...
import { prevent as prevent14 } from "@heintouchable/functions";
import { capitalize } from "@heintouchable/functions";
...
var TiptapToolbarAlign = ({
  ...
  return /* @__PURE__ */ jsxs26(TiptapDropdown, {
    ...
    children: [
      ...
      alignments.filter((align) => align !== currentAlign).map((align) => /* @__PURE__ */ jsx45(TiptapToolbarButton, {
        onClick: prevent14(
...
import { prevent as prevent15 } from "@heintouchable/functions";
...
var TiptapToolbarHeadings = ({
  ...
  const clickHandler = (level) => prevent15(() => {
    if (!level) {
      return;
    }
  ...
  return /* @__PURE__ */ jsxs27(TiptapDropdown, {
    ...
    children: [
      ...
      levels.map((level) => /* @__PURE__ */ jsx46(TiptapToolbarButton, {
...
import { colorToProperty } from "@heintouchable/functions";
import styled28 from "@emotion/styled";
import { prevent as prevent16 } from "@heintouchable/functions";
import { useToggle as useToggle4 } from "@heintouchable/functions";
import { jsx as jsx47, jsxs as jsxs28 } from "@emotion/react/jsx-runtime";
function TiptapColorPicker({ editor, colors }) {
  const currentColor = editor?.getAttributes("textStyle").color;
  const cssColors = useMemo5(
  ...
  return /* @__PURE__ */ jsxs28("div", {
    ...
    children: [
      ...
      expanded && /* @__PURE__ */ jsx47(Palette, {
        colors: cssColors,
        onChange: handleChange
      })
    ]
...
function Palette({
  ...
  return /* @__PURE__ */ jsx47(PaletteWrapper, {
    size: colors.length,
    children: colors.map((color) => /* @__PURE__ */ jsx47(PaletteItem, {
...
// src/components/Editor/TiptapEditor/TiptapToolbar.tsx
import { Fragment as Fragment9, jsx as jsx48, jsxs as jsxs29 } from "@emotion/react/jsx-runtime";
var iconSize = 16;
function TiptapToolbar({ editor, colors }) {
  ...
  return /* @__PURE__ */ jsx48(Toolbar, {
    ...
    children: mode === 1 /* Link */ ? /* @__PURE__ */ jsx48(ToolbarLink, {
      onSubmit: insertLink,
...
function ToolbarButtons({
  ...
  return /* @__PURE__ */ jsxs29(Fragment9, {
    children: [
      editor.can().toggleOrderedList() && /* @__PURE__ */ jsx48(TiptapToolbarButton, {
        onClick: prevent17(
      ...
      editor.can().toggleBulletList() && /* @__PURE__ */ jsx48(TiptapToolbarButton, {
        onClick: prevent17(
      ...
      editor.can().toggleBlockquote() && /* @__PURE__ */ jsx48(TiptapToolbarButton, {
        onClick: prevent17(
      ...
      /* @__PURE__ */ jsx48(TiptapToolbarButton, {
        onClick: prevent17(() => editor.chain().focus().toggleUnderline().run()),
      ...
      /* @__PURE__ */ jsx48(TiptapToolbarButton, {
        onClick: prevent17(() => editor.chain().focus().toggleHighlight().run()),
...
import { useEffect as useEffect9, useRef as useRef9, useState as useState12 } from "react";
...
function TiptapEditor({
  ...
  return /* @__PURE__ */ jsxs30(EditorWrapper, {
    ...
    children: [
      ...
      editor && /* @__PURE__ */ jsx49(TiptapToolbar, {
        editor,
        colors
      })
    ]
...
import { colorToProperty as colorToProperty2 } from "@heintouchable/functions";
...
import { prevent as prevent18 } from "@heintouchable/functions";
import { useState as useState13 } from "react";
import * as Popover from "@radix-ui/react-popover";
import { colorToProperty as colorToProperty3 } from "@heintouchable/functions";
...
var Component6 = ({
  ...
  const changeHandler = (color) => prevent18(() => {
    onChange(color);
    setOpen(false);
  });
        ...
        children: [
          /* @__PURE__ */ jsx51(Popover.Trigger, {
            ...
            children: /* @__PURE__ */ jsx51("button", {
              className: `${_default6.button} ${value === null ? _default6.transparent : ""}`,
              style: value ? {
          ...
          /* @__PURE__ */ jsx51(Popover.Content, {
            ...
            children: /* @__PURE__ */ jsxs31("div", {
              ...
              children: [
                ...
                options.colors.map((color) => /* @__PURE__ */ jsx51("button", {
...
import { capitalize as capitalize2 } from "@heintouchable/functions";
...
var Component7 = ({
  ...
  return /* @__PURE__ */ jsx55(Field, {
    ...
    children: /* @__PURE__ */ jsx55(AlignmentButtons, {
      children: alignements.map((alignment) => /* @__PURE__ */ jsx55(AlignmentButton, {
        value: alignment,
...
import { useUniqId as useUniqId4 } from "@heintouchable/functions";
...
import { useUniqId as useUniqId5 } from "@heintouchable/functions";
...
// src/fields/Range.tsx
import { Fragment as Fragment10, jsx as jsx58, jsxs as jsxs33 } from "@emotion/react/jsx-runtime";
var Component10 = ({
  value,
  onChange,
  options
...
var Component11 = ({
  ...
  return /* @__PURE__ */ jsx59(Tabs, {
    children: options.tabs.map((tab) => /* @__PURE__ */ jsx59(Tabs.Tab, {
      title: tab.label,
...
import { prevent as prevent19 } from "@heintouchable/functions";
import { useUniqId as useUniqId6 } from "@heintouchable/functions";
import { Field as FieldUi2 } from "@heintouchable/ui";
...
import { useUniqId as useUniqId7 } from "@heintouchable/functions";
...
var Component13 = ({
  ...
  return /* @__PURE__ */ jsx61(Field, {
    ...
    children: /* @__PURE__ */ jsx61(AlignmentButtons, {
      children: alignements.map((alignment) => /* @__PURE__ */ jsx61(AlignmentButton, {
        name: id,
        value: alignment,
        checked: value === alignment,
        onChange,
